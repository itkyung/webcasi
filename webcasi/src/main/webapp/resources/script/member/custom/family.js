...
function showDepth(itemId){
	...
	if(_nurseViewFlag){
		secondFrame.attr("src",_requestPath + "/nurse/custom/family2Depth/" + itemId + "?instanceId=" + _instanceId);
	}else{
		secondFrame.attr("src",_requestPath + "/member/checkup/custom/family2Depth/" + itemId + "?previewFlag=" + _previewFlag);
	}
